...
// ⚠️⚠️⚠️ 2D array row-pointer decay ( *pp gives pointer to row's 1st element )
...
// int (*pFull)[3][4] = &arr;
// cout << pFull << endl ;
// cout << pFull + 1 << endl ;                       // +48 bytes ( 12 elements * 4 bytes )  


// int (*pRow)[4]    = arr ;              // Same as &arr[0]
// cout << pRow << endl ; 
// cout << pRow + 1 << endl ;                        // +16 bytes ( 4 elements * 4 bytes )                  


// int *pElem       = arr[0];            // Same as &arr[0][0] or *arr
// cout << pElem << endl;
// cout << pElem + 1 << endl;                        // +4 bytes ( 1 element * 4 bytes)
